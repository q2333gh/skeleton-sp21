...
public class TestUtils {
  ...
  /**
   * Checks that the static variable model is configured as described by VALUES with score attribute
   * SCORE.
   *
   * @param values    - a 2D array of integers describing the expected board a "0" element
