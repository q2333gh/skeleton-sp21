...
public class Board implements Iterable<Tile> {
   ...
   * current score of SCORE and the viewing perspective set to north. 什么是viewing perspective??
   */
  ...
  /**
   * Return the current Tile at (COL, ROW), when sitting with the board oriented so that SIDE is at
   * the top (farthest) from you.
   */
